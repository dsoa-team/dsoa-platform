...
public abstract class DsoaBaseCommand implements DsoaCommand {
	...
	/* (non-Javadoc)
	 * @see br.ufpe.cin.dsoa.platform.shell.DsoaCommand#getUsage()
	 */
	...
	/* (non-Javadoc)
	 * @see br.ufpe.cin.dsoa.platform.shell.DsoaCommand#getParameters()
	 */
	public abstract List<String> getParameters();

	/* (non-Javadoc)
	 * @see br.ufpe.cin.dsoa.platform.shell.DsoaCommand#getName()
	 */
	public abstract String getName();

	/* (non-Javadoc)
	 * @see br.ufpe.cin.dsoa.platform.shell.DsoaCommand#getShortDescription()
	 */
	public abstract String getShortDescription();

	/* (non-Javadoc)
	 * @see br.ufpe.cin.dsoa.platform.shell.DsoaCommand#execute(java.lang.String, java.io.PrintStream, java.io.PrintStream)
	 */
