...
import br.ufpe.cin.dsoa.service.impl.OsgiServiceSpecification;
...
//			qdl.onArrival(new OsgiServiceSpecification(servicePid, reference, serviceObject));
			ServiceTracker s =new ServiceTracker(context, reference, null) {
				@Override
				public void removedService(ServiceReference reference, Object object) {
					String servicePid = (String)reference.getProperty(Constants.SERVICE_PID);
//					qdl.onDeparture(new OsgiServiceSpecification(servicePid, reference, object));
