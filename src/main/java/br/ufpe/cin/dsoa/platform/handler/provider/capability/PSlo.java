package br.ufpe.cin.dsoa.platform.handler.provider.capability;
...
import br.ufpe.cin.dsoa.platform.handler.provider.ProviderMetadata;
...
public class PSlo {
	...
	public PSlo(String description) {
