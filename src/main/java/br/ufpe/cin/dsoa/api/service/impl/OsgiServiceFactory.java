...
public class OsgiServiceFactory {
	...
	public static ServiceInstance getOsgiService(String itfName, ServiceReference reference, boolean isProxy) {
		...
		// TODO POR ENQUANTO O ID DO SERVI�O VIR� DE UMA DAS PROPRIEDADES ( "service.pid" ou  "service.id").
		// Quando o ProvidesHandler estiver funcional, isso dever� ser modificado para obter o nome 
		// da porta provida.
