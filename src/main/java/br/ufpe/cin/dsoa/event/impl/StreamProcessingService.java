...
import br.ufpe.cin.dsoa.agent.ProcessingQuery;
...
public abstract class StreamProcessingService {
	...
	public abstract QueryBuilder getQueryBuilder(EventProcessingAgent agent);

	public abstract void startQuery(Query query);
}